...
@interface DTSideMenuViewController ()
...
@implementation DTSideMenuViewController
...
- (void)setSideMenuViewController:(DTSideMenuViewController *)sideMenuViewController {
    objc_setAssociatedObject(self, @selector(sideMenuViewController), sideMenuViewController, OBJC_ASSOCIATION_ASSIGN);
}

- (DTSideMenuViewController *)sideMenuViewController {
    DTSideMenuViewController *sideMenuController = objc_getAssociatedObject(self, @selector(sideMenuViewController));
